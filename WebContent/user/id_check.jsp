...
<script type="text/javascript">
	function returnId(){
		...
		opener.document.fr.idcheck.value = "체크완료";
...
<body>
	...
	<form id="fr" style="font-size: 2em;" action="id_check.jsp" method="post" name="fr">
	<%
	...
	%>
		<br>
		<input type="text" value="<%=id%>" id="id" name="id" style="width: 100%;"><br>
		<%
		if(result == 1){
		%>
		...
		<%}else{ %>
		<input type="submit" value="중복체크">
		<input type="button" value="사용하기" onclick="returnId();">
		<%} %>
	</form>
	</div>
</body>
