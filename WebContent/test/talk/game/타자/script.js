(function() {
  ...
  function EnemyWave(params) {
    ...
    function Lib() {
      var lib = {
        1: "nil=balalbasjd lib go pen var if add zsh run php bug fix api key add all id em erb rem px ux ui svg for box git xml rtc pre rgb hsl rel web js def moz end to dev css".split(" "),
